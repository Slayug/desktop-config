...
- [ ] Liste des packets à installer par défaut, tmux, Ansible, xdotool, omf, docker (setup without root), discord, powerline-fonts, (curl https://raw.githubusercontent.com/oh-my-fish/oh-my-fish/master/bin/install | fish)
