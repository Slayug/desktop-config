...
- [ ] Liste des packets à installer par défaut, tmux, Ansible, xdotool, omf, node/npm (without sudo), maven, helm, kubens, kubectl (https://github.com/evanlucas/fish-kubectl-completions), gcloud, docker (setup without root), discord, powerline-fonts, (curl https://raw.githubusercontent.com/oh-my-fish/oh-my-fish/master/bin/install | fish)
